...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-zinc-200 bg-white text-black shadow-sm dark:border-zinc-800 dark:bg-black dark:text-zinc-50",
      className
    )}
    {...props}
  />
...
export const CardFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("p-4 border-t dark:border-zinc-800", className)} {...props} />
));
